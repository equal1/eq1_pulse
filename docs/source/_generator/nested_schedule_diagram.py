...
def create_nested_schedule_diagram():
    """Create and return the nested schedule diagram figure.
    ...
    ax.text(
        block3_start + block3_width / 2, timeline_y + 1.1, "50ns", fontsize=8, ha="center", va="center", style="italic"
    )
    ...
    # init.end
    ax.plot(
        [block1_start + block1_width, block1_start + block1_width],
        [timeline_y, ref_pt_y],
        "k--",
        linewidth=1,
        alpha=0.5,
    ...
    # rabi.end
    ax.plot(
        [block2_start + block2_width, block2_start + block2_width],
        [timeline_y, ref_pt_y],
        "k--",
        linewidth=1,
        alpha=0.5,
