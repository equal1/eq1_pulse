...
with chdir(output_dir):
    ...
    output_pdf = "pulse_sequence_diagram.pdf"
    plt.savefig(output_pdf, bbox_inches="tight", facecolor="white")
    print(f"PDF saved to: {output_dir}/{output_pdf}")

    # Also save PNG for compatibility
    output_png = "pulse_sequence_diagram.png"
    plt.savefig(output_png, dpi=150, bbox_inches="tight", facecolor="white")
    print(f"PNG saved to: {output_dir}/{output_png}")

    # Also save SVG for HTML
    output_svg = "pulse_sequence_diagram.svg"
    plt.savefig(output_svg, bbox_inches="tight", facecolor="white")
    print(f"SVG saved to: {output_dir}/{output_svg}")
