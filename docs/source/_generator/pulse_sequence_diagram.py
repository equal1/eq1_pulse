...
def create_pulse_sequence_diagram():
    """Create and return the pulse sequence diagram figure.
    ...
    ax.text(
        pulse_duration + readout_duration / 2, 1.85, "1 μs", ha="center", fontsize=8, color="blue", fontweight="bold"
    )
    ...
    legend_elements = [
        mpatches.Patch(
            facecolor=qubit_color, edgecolor=qubit_color, alpha=0.7, label="Drive Pulse (variable amplitude)"
        ),
