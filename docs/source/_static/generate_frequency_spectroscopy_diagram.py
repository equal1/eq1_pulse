#!/usr/bin/env python3
"""Generate pulse sequence diagram for frequency spectroscopy experiment."""
...
def generate_frequency_spectroscopy_diagram():
    """Create a pulse sequence diagram for frequency spectroscopy."""
    ...
    ax.text(
        freq_arrow_x, channel_y + 0.5, "set_freq(f)", ha="left", va="bottom", fontsize=9, weight="bold", color="#C1121F"
    )
...
def main():
    ...
    base_name = "frequency_spectroscopy_pulse_diagram"

    fig = generate_frequency_spectroscopy_diagram()
