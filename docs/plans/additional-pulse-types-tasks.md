...
**Run last**, after [#6](https://github.com/equal1/eq1_pulse/issues/6) (landed) and
...
> — a too-narrow parameter hint is not a type error. See the [#6 design record](https://github.com/equal1/eq1_pulse/issues/6#issuecomment-5371855226).
>
