...
**Date:** 2026-08-21
**Predecessors:** independent of [#6](https://github.com/equal1/eq1_pulse/issues/6) (landed) and
[expressions-plan.md](expressions-plan.md) (#3) in substance, but if run after them its new fields
must use the widened `ValueRef` alias rather than `VariableRef`. See §1.
