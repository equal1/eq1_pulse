...
**Date:** 2026-08-21
**Predecessor:** [symbols-and-parameters-plan.md](symbols-and-parameters-plan.md) (#6). **This plan
assumes #6 has landed.** It widens the `SymbolRef` alias introduced there; without it, every
widening in §3 has to be done twice.
