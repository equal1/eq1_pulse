...
def example_schedule_with_parallel_operations():
    ...
    with build_schedule() as sched:
        ...
        add_block(initialize_qubit("qubit1"), op_name="init1", ref_op=init0, ref_pt="start")

        # Apply gates in parallel
        gate0 = add_block(rabi_drive("qubit0", "140mV"), op_name="gate0", ref_op=init0, ref_pt="end", rel_time="20ns")
        gate1 = add_block(
