...
def example_basic_t2star():
    ...
    with build_sequence() as seq:
        ...
        with for_("tau", delay_sweep):
            ...
            wait("qubit", duration=var("tau"))  # tau in μs
            ...
            # Measurement via sensor (complex variable with demod)
            measure(
                "readout",
...
def example_t2star_echo():
    ...
    with build_sequence() as seq:
        ...
        with for_("tau", delay_sweep):
            ...
            wait("qubit", duration=var("tau"))  # tau/2 in μs
...
def example_t2star_vs_magnetic_field():
    ...
    with build_sequence() as seq:
        ...
        with for_("field", field_sweep):
            ...
            set_frequency("qubit", var("field"))  # Proxy for B-field
    ...
    with build_sequence() as seq:
        ...
        with for_("tau", delay_sweep):
            with for_("phi", phase_sweep):
                ...
                set_phase("qubit", var("phi"))  # phi in degrees
